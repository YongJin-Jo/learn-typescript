...
var CovidState;
(function (CovidState) {
    CovidState["Confirmed"] = "confirmed";
    CovidState["Recovered"] = "recovered";
    CovidState["Deaths"] = "deaths";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    isDeathLoading = true;
                    return [4 /*yield*/, fetchCountryInfo(selectedId, CovidState.Deaths)];
                case 1:
                    deathResponse = (_a.sent()).data;
                    return [4 /*yield*/, fetchCountryInfo(selectedId, CovidState.Recovered)];
                case 2:
                    recoveredResponse = (_a.sent()).data;
                    return [4 /*yield*/, fetchCountryInfo(selectedId, CovidState.Confirmed)];
                case 3:
...
function renderChart(data, labels) {
    var ctx = $('#lineChart');
    ctx.getContext('2d');
    chart_js_1.default.defaults.color = '#f5eaea';
    chart_js_1.default.defaults.font.family = 'Exo 2';
